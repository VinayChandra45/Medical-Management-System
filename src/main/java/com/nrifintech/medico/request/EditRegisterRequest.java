...
public class EditRegisterRequest {
	...
	public EditRegisterRequest(String name, String username, int fees, String password, String specialization,
			Date practice_started, String degree, String descr, String profile_pic) {
		super();
		this.name = name;
